...
def main():
    ...
    # Deal the cards
    print("Player 1")
    p1Hand = deal_cards(deck, 0)
    print("\nPlayer 2")
    p2Hand = deal_cards(deck, 0)

    if (p1Hand < 21 and p2Hand < 21):
        print("Player 1")
        p1Hand_2 = deal_cards(deck, p1Hand)
        print("\nPlayer 2")
        p2Hand_2 = deal_cards(deck, p2Hand)
...
def deal_cards(deck, hand_value):
    ...
    while again == 'y':
        ...
        if hand_value > 21:
            print("You lose!")
            break
        again = input("To draw again type y: ")
